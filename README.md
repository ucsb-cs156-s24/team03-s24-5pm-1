...
|---------------------------|---------------------|--------------|
| UCSBDiningCommonsMenuItem | Rick T. Zhang       | rtzhang1x    |
| UCSBOrganization          | Yulin Lin           | ylin250      |
| RecommendationRequest     | Shuhan Lyu          | JUstISAGE    |
| MenuItemReview            | Peak Manopchantaroj | Peak1260     |
| HelpRequest               | George Nebieridze   | GeorgebigG   |
| Articles                  | Sanjay Srikanth     | Crossover661 |
