...
public class ArticleIT {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                Articles articles = Articles.builder()
                        ...
                        .explanation("zxcvbnm")
                        .email("qazwsxedc")
                        .dateAdded(LocalDateTime.parse("2022-02-22T22:22:22"))
                        .build();
        ...
        public void an_admin_user_can_post_a_new_articles() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/articles/post?title=qwertyuiop&url=asdfghjkl&explanation=zxcvbnm&email=qazwsxedc&dateAdded=2022-02-22T22:22:22")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
