...
public class ArticleWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_articles() throws Exception {
        ...
        page.getByTestId("ArticlesForm-title").fill("My Article");
        page.getByTestId("ArticlesForm-url").fill("myarticle.com");
        page.getByTestId("ArticlesForm-explanation").fill("I can't explain");
        page.getByTestId("ArticlesForm-email").fill("sanjay@myarticle.com");
        page.getByTestId("ArticlesForm-dateAdded").fill("2024-06-03T23:59");
        ...
        page.getByTestId("ArticlesForm-title").fill("qwertyuiop");
        page.getByTestId("ArticlesForm-submit").click();

        assertThat(page.getByTestId("ArticlesTable-cell-row-0-col-title")).hasText("qwertyuiop");
