            ...
            </Nav>
            {
              currentUser && currentUser.loggedIn && (
                <>
                  ...
                  <Nav.Link as={Link} to="/ucsbmenuitems">Dining Commons Menu Items</Nav.Link>
=======
                  <Nav.Link as={Link} to="/ucsbrecommendationrequests">UCSBRecommendationRequests</Nav.Link>
                  ...
                  <Nav.Link as={Link} to="/menuitemreviews">MenuItemReviews</Nav.Link>
