...
describe("UCSBDiningCommonsMenuItemIndexPage tests", () => {
    ...
    test("Renders with Create Button for admin user", async () => {
        ...
        expect(button).toHaveAttribute("href", "/ucsbmenuitem/create");
    ...
    test("renders three dates correctly for regular user", async () => {
        ...
        setupUserOnly();
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/ucsbmenuitem/all").reply(200, ucsbDatesFixtures.threeDates);
    ...
    test("renders empty table when backend unavailable, user only", async () => {
        ...
        expect(errorMessage).toMatch("Error communicating with backend via GET on /api/ucsbmenuitem/all");
        restoreConsole();
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/ucsbmenuitem/all").reply(200, ucsbDatesFixtures.threeDates);
        axiosMock.onDelete("/api/ucsbmenuitem").reply(200, "UCSBDiningCommonsMenuItem with id 1 was deleted");
