...
describe("AppNavbar tests", () => {
    ...
    test("renders the menuitemreviews link correctly", async () => {
        ...
        await screen.findByText("MenuItemReviews");
        const link = screen.getByText("MenuItemReviews");
        expect(link).toBeInTheDocument();
        expect(link.getAttribute("href")).toBe("/menuitemreviews");
    });
